#' @title Fonction qui donne des conclusions de l'analyse
#' @import lubridate
#' @usage detect_anoma_chambre(list.data,num_chambre,seuil_data,k_pas,s,seuil_delete,seuil_cut,seuil_stat,t_eau_maxi,seuil_tdep,seuil_length)
...
#' @param seuil_tdep seuil de variation de la température de départ, 0.003 par défault
...
#' @return \code{deleted_room_names} liste de jeux de données dont la chambre/zone à chauffer numéro num_chambre n'est pas déclarée
...
detect_anoma_chambre <- function(list.data,num_chambre,seuil_data = 12,k_pas = 6,s = 0.0065,seuil_delete=5,seuil_cut=21
                                    ,seuil_stat=5e-5,t_eau_maxi=90,seuil_tdep=0.003,seuil_length=12){
